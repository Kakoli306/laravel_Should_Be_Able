...
<div class="container">
    <div class="women_main">
        ...
        <div class="col-md-9 w_content">
            ...
            <div class="grids_of_4">
                ...
                <div class="grid1_of_4">
                    <div class="content_box"><a href="{{ url('/product-details') }}">
                    ...
                    <h4><a href="details.html">{{$productByCategoryId->product_name}}</a></h4>
                    <p>It is a long established fact that a reader</p>
                    BDT {{$productByCategoryId->product_price}}
                </div>
            </div>
                @endforeach
        ...
        <h4><a href="{{ url('/product-details') }}"> Duis autem</a></h4>
        <p>It is a long established fact that a reader</p>
        Rs. 499
    </div>
</div>
